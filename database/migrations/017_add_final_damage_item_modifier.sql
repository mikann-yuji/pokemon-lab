...
CREATE TABLE champions_item_damage_modifiers_new (
  ...
  modifier_kind TEXT NOT NULL CHECK (
    modifier_kind IN ('power', 'attacking_stat', 'final_damage', 'received_damage')
  ),
...
INSERT INTO champions_item_damage_modifiers_new
SELECT * FROM champions_item_damage_modifiers;

DROP TABLE champions_item_damage_modifiers;
ALTER TABLE champions_item_damage_modifiers_new
  RENAME TO champions_item_damage_modifiers;
